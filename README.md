# 📝 TaskList - Gerenciador de Tarefas com Foco

O **TaskList** é um aplicativo Android moderno desenvolvido para ajudar na organização diária e produtividade. Ele combina o gerenciamento de tarefas simples com um sistema de cronômetro (estilo Pomodoro) e estatísticas de desempenho.

## 🚀 Funcionalidades

- **Gerenciamento de Tarefas:** Adicione, edite e remova tarefas com diferentes níveis de prioridade.
...
| Lista de Tarefas | Estatísticas | Modo Foco |
| :---: | :---: | :---: |
